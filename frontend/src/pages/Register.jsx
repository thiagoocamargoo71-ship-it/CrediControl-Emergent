...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(formatApiErrorDetail(error.response?.data?.detail) || 'Erro ao criar conta');
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-md w-full mx-auto animate-fade-in">
          ...
          <div className="mb-8">
            ...
            <p className="text-neutral-400 mt-2">
              Crie sua conta e comece a gerenciar seus empréstimos
            </p>
          </div>
        ...
        <div className="absolute bottom-12 left-12 right-12">
          <div className="bg-neutral-900/80 backdrop-blur-xl border border-neutral-800 rounded-xl p-6">
            <p className="text-neutral-300 text-lg leading-relaxed">
              "Controle total sobre seus empréstimos. Parcelas automáticas, juros calculados e histórico completo."
            </p>
